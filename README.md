...
├── doc/                          # เอกสารอ้างอิงและเอกสารโครงการ (เช่น CFO Report, Chula SDG, และเอกสาร Hackathon)
...
*   **หมายเหตุโฟลเดอร์ [doc/](file:///c:/Users/Natth/Documents/cu-energy/doc):** ประกอบไปด้วยเอกสารอ้างอิงและคู่มือโครงการที่เป็นประโยชน์ต่อการศึกษาภาพรวมพลังงานของจุฬาฯ ได้แก่:
    *   `619413680110436681_Chula SD_2025.pdf` — รายงานการพัฒนาอย่างยั่งยืนของจุฬาลงกรณ์มหาวิทยาลัย (Sustainable Development Report)
    *   `Final Report_CFO Chula_07-08-24 2-4-20.pdf` — รายงานคาร์บอนฟุตพริ้นท์ขององค์กร (Carbon Footprint of Organization: CFO) ของจุฬาฯ
    *   `ประกาศรับสมัครผู้เข้าร่วมแข่งขัน V4.pdf` และ `สไลด์-hack the energy.pdf` — ข้อมูลรายละเอียดและโจทย์การแข่งขัน Hack the Energy
